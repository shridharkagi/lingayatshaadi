...
export default function ContactPage() {
  ...
  const whatsappUrl = `https://wa.me/${whatsappNumber}?text=${encodeURIComponent(config.whatsappDefaultMessage || "I need assistance, my name: ")}`;
    ...
    <div className="min-h-screen bg-[var(--color-bg)] flex flex-col">
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-4 py-8">
        ...
        <p className="text-[var(--color-text-muted)] mb-8">
          We&apos;re here to help. Reach out through any of the channels below. Available 9 AM–9 PM, seven days a week.
        </p>

        <div className="space-y-4">
          <a
            href="mailto:support@lingayatshaadi.com"
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-[var(--color-text-muted)]">support@lingayatshaadi.com</p>
            </div>
          </a>
          ...
          {hasCall && (
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-[var(--color-text-muted)]">{config.callContactNumber}</p>
              </div>
            </a>
          )}
          ...
          {hasWhatsApp && (
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-[var(--color-text-muted)]">{config.whatsappContactNumber}</p>
              </div>
            </a>
          )}
        </div>
        ...
        <div className="mt-8 p-4 rounded-xl bg-white border border-[var(--color-border)]">
          ...
          <div className="space-y-3 text-sm text-[var(--color-text-muted)]">
            <p><strong className="text-[var(--color-text-primary)]">How do I verify my profile?</strong><br />Go to Profile → Trust Badge and follow the verification steps.</p>
            <p><strong className="text-[var(--color-text-primary)]">How do I upgrade to Premium?</strong><br />Go to Profile → Membership and choose a plan.</p>
          </div>
        </div>
      </main>
    </div>
