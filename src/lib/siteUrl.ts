 ...
 * Set `NEXT_PUBLIC_SITE_URL` in production (e.g. https://lingayatshaadi.in).
 */
export function getPublicSiteUrl(): string {
  ...
  if (raw) {
    ...
    // Allow Vercel value like "test.lingayatshaadi.in" without scheme
  ...
  return "https://test.ligayatshaadi.in";
}
